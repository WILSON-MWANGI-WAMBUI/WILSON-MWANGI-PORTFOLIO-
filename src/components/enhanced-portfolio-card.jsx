      ...
      <motion.div
        ...
        <Card
          ...
          <motion.h1
            ...
            WILSON MWANGI WAMBUI
          </motion.h1>
          <motion.a
            href="mailto:mwangiwilson137@gmail.com"
            className="text-lg text-blue-400 hover:text-blue-300 transition-colors"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ delay: 0.3, duration: 0.5 }}>
            mwangiwilson137@gmail.com
          </motion.a>
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            ...
            <motion.div
              ...
              <div className="flex justify-between items-center">
                ...
                <Badge
                  ...
                  Hello, I'm WILSON MWANGI WAMBUI
                </Badge>
              </div>
              <p className="text-gray-300 text-lg leading-relaxed">
              a dedicated Software Engineer with a passion for crafting robust and innovative solutions. My journey in the world of technology has been an exciting exploration, and I'm thrilled to share a bit about myself with you
              </p>
              <p className="text-gray-300 text-lg leading-relaxed">
